...
function renderAuthSchemasRuntime(args: {
  login: Partial<Record<ProviderName, Record<string, unknown>>>;
  user: Partial<Record<ProviderName, Record<string, unknown>>>;
}): string {
...
function renderAuthSchemasTypes(): string {
  return `// AUTO-GENERATED by @workmate/nuxt-auth — do not edit.
import type { z } from "zod";

export declare const loginSchemas: { local?: z.ZodType; github?: z.ZodType; google?: z.ZodType };
export declare const userSchemas: { local?: z.ZodType; github?: z.ZodType; google?: z.ZodType };
...
export default defineNuxtModule<ModuleOptions>({
  ...
  async setup(options, nuxt) {
    ...
    addTemplate({
      ...
      write: true,
      getContents: () => renderAuthSchemasTypes(),
    });
